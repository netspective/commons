...
public class HibernateDiagramTableNameNodeGenerator extends HibernateDiagramTableStructureNodeGenerator
{
    public HibernateDiagramTableNameNodeGenerator(final String name)
    {
        super(name);
