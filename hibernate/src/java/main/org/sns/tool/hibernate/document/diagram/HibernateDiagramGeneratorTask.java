...
public class HibernateDiagramGeneratorTask extends Task
{
    private Class hibernateConfigClass;
    private String hibernateConfigFile;
    private Class diagramFilterClass;
    private String diagramId = "diagram";
    ...
    public void execute() throws BuildException
    {
        ...
        try
        {
            final HibernateDiagramGeneratorFilter filter = (HibernateDiagramGeneratorFilter) diagramFilterClass.newInstance();
            ...
            final GraphvizDiagramGenerator gdg = new GraphvizDiagramGenerator(diagramId, true, GraphvizLayoutType.DOT);
    ...
    public void setHibernateConfigClass(final String className) throws ClassNotFoundException
    {
        hibernateConfigClass = Class.forName(className);
    }

    public void setDiagramFilterClass(final String className) throws ClassNotFoundException
    {
        diagramFilterClass = Class.forName(className);
    }
}
